const pianoTeclas = document.querySelectorAll('.tecla'); // Selecciona todas las teclas 
...
pianoTeclas.forEach((tecla, i) => { // Recorre todas las teclas
    ...
    tecla.addEventListener('click', () => playSound(newUrl)); // Agrega un evento click a cada tecla
});
